...
from datamodel.search.ShijinlKye7JiehuizHongxins_datamodel import ShijinlKye7JiehuizHongxinsProjectionLink
...
@Deleter(ShijinlKye7JiehuizHongxinsProjectionLink)
@Getter(ShijinlKye7JiehuizHongxinsProjectionLink)
class DeleteFrontierFrame(IApplication):
    ...
    def update(self):
        ...
        ls = self.frame.get(ShijinlKye7JiehuizHongxinsProjectionLink)
        print "Found ", len(ls), " links to delete."
        for l in ls:
            self.frame.delete(ShijinlKye7JiehuizHongxinsProjectionLink, l)
